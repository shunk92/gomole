...
// NewEndpoint makes new endopoint information
...
// SSHTunnel represents tunnel information
...
// PrivateKeyFile assign private key file path
...
// NewSSHTunnel makes SSHTunnel
func NewSSHTunnel(tunnel string, auth ssh.AuthMethod, destination string, port int) *SSHTunnel {
